...
def get_odontograma(paciente_id: int, db: Session = Depends(get_db)):
...
def save_odontograma(paciente_id: int, data: schemas.OdontogramaCreate, db: Session = Depends(get_db)):
